...
static constexpr auto qt_meta_stringdata_CLASSqfi_ASIENDCLASS = QtMocHelpers::stringData(
    "qfi_ASI"
);
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSqfi_ASIENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSqfi_ASIENDCLASS_t qt_meta_stringdata_CLASSqfi_ASIENDCLASS = {
    {
        QT_MOC_LITERAL(0, 7)   // "qfi_ASI"
    },
    "qfi_ASI"
};
